 ...
 <div className="calculator">
   ...
   <form action="" method="get" className="invoices">
     <div className="invoiceOne">
       <label for="firstInvoice">1st Invoice Amount: </label>
       <input type="text" name="firstInvoice" id="firstInvoice" className='invoice' placeholder='0'  required></input>
     </div>
     <div className="invoiceTwo">
       <label for="secondInvoice">2nd Invoice Amount: </label>
       <input type="text" name="secondInvoice" id="secondInvoice" className='invoice' placeholder='0'  required></input>
     </div>
     <div className="invoiceThree">
       <label for="thirdInvoice">3rd Invoice Amount: </label>
       <input type="text" name="thirdInvoice" id="thirdInvoice" className='invoice' placeholder='0'  required></input>
     </div>
