 ...
 <div className="calculator">
   ...
   <form action="" method="get" className="invoices">
     <div className="invoiceOne">
       ...
       <input type="text" name="firstInvoice" id="firstInvoice" className='invoice' required></input>
     </div>
     <div className="invoiceTwo">
       <label for="secondInvoice">2nd Invoice: </label>
       <input type="text" name="secondInvoice" id="secondInvoice" className='invoice'  required></input>
     </div>
     <div className="invoiceThree">
       <label for="thirdInvoice">3rd Invoice: </label>
       <input type="text" name="thirdInvoice" id="thirdInvoice" className='invoice'  required></input>
     </div>
